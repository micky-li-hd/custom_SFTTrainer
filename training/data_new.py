...
class DataCollatorForSupervisedDataset:
    ...
    def __call__(self, instances: Sequence[Dict]) -> Dict[str, torch.Tensor]:
        ...
        for key in padded_tensors:
            ...
            # elif tensor.shape[1] < max_len:  # 长度不足时填充
            #     pad_size = (tensor.shape[0], max_len - tensor.shape[1])
            #     pad_tensor = torch.full(pad_size, fill_value=self.tokenizer.pad_token_id, 
